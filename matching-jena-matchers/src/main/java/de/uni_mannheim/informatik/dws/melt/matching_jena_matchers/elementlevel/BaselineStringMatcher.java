...
public class BaselineStringMatcher extends MatcherYAAAJena {
    ...
    public static BagOfWords normalize(String stringToBeNormalized) {
        ...
        */
        stringToBeNormalized = stringToBeNormalized.contains("@") ? stringToBeNormalized.substring(stringToBeNormalized.indexOf("@")) : stringToBeNormalized; //remove language tag
