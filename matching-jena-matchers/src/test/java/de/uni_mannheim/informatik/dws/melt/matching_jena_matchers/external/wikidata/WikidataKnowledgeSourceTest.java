...
class WikidataKnowledgeSourceTest {
    ...
    void isHypernym(boolean isBufferEnabled){
        ...
        // check with URIs
        // replace Q1048835 with Q4120211
        ...
        assertTrue(wikidata.isHypernym("http://www.wikidata.org/entity/Q4120211", "http://www.wikidata.org/entity/Q458", 1));
        assertTrue(wikidata.isHypernym("http://www.wikidata.org/entity/Q56061", "http://www.wikidata.org/entity/Q458", 2));

        // check with links
        String linkQ4120211 = wikidata.getLinker().linkToSingleConcept("regional organization");
        ...
        assertTrue(wikidata.isHypernym(linkQ4120211, linkQ458, 1));
        assertTrue(wikidata.isHypernym(linkQ56061, linkQ458, 2));
        assertTrue(wikidata.isHypernym(linkQ4120211, linkQ458, 3));

        // run again to see whether buffer works
        assertTrue(wikidata.isHypernym(linkQ4120211, linkQ458, 3));

        // combinations
        assertTrue(wikidata.isHypernym("http://www.wikidata.org/entity/Q4120211", linkQ458, 1));
