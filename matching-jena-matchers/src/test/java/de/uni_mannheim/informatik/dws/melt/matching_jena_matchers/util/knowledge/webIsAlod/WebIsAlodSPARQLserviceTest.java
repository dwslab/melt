...
import de.uni_mannheim.informatik.dws.melt.matching_jena_matchers.util.knowledge.webIsAlod.classic.WebIsAlodClassicLinker;
...
class WebIsAlodSPARQLserviceTest {
    ...
    void isSynonymousClassic() {
     ...
     @Test
     @Disabled // Unfortunately, the queries are to complex for the endpoint.
     void isSynonymousXL() {
