...
public class NLPTransformersFilter extends MatcherYAAAJena implements Filter {
     ...
     *   function in huggingface library</a>). In case of a path, it should be absolute. It can be generated by {@link FileUtil#getCanonicalPathIfPossible(java.io.File) }
    ...
    public List<Double> predictConfidences(File predictionFilePath) throws Exception{
        return PythonServer.getInstance().transformersPrediction(this.modelName, predictionFilePath, this.usingTF,
                this.cudaVisibleDevices, this.transformersCache, this.changeClass, this.config);
    }
