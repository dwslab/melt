...
public class MatcherPipelineSequential implements IMatcherCaller {
    ...
    public AlignmentAndParameters match(Set<Object> sourceRespresentations, Set<Object> targetRespresentations, Object inputAlignment, Object parameters) throws Exception {
        ...
        for(Object matcher : this.matchers){
            AlignmentAndParameters matcherResult = GenericMatcherCaller.runMatcherMultipleRepresentations(matcher, sourceRespresentations, targetRespresentations, tmpAlignment, tmpParameters);
